...
contract LotusCoin is Context, IBEP20, Ownable {
    ...
    string private _name = "LotusCoin";
    string private _symbol = "LTSCN";
    ...
    uint256 public _maxTxAmount = 12000000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 1200000000000 * 10**18;
